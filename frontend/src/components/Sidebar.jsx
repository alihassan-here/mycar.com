...
const Sidebar = ({ side, closeSidebar }) => {
  ...
  return (
    ...
    >
      ...
      ></i>
      <div className="bg-white p-4">{/* <img src="../" alt="logo" /> */}</div>
      <ul className="mt-4 p-0">
        <li
          className={`px-4 cursor-pointer transition-all py-3 text-white flex items-center hover:bg-gray-600 ${
            activeRoute.includes("product") ? "bg-gray-600" : ""
          }`}
        >
        ...
        <li
          className={`px-4 cursor-pointer transition-all py-3 text-white flex items-center hover:bg-gray-600 ${
            activeRoute.includes("categor") ? "bg-gray-600" : ""
          }`}
        >
